...
!
                        ...
                        if (np > MAX_MAPPED_GRID) then 
                           ...
                           write(*,fmt='(A)') "[error] - Number of effected "//&
                              "ocean grid points greater than ", MAX_MAPPED_GRID 
...
!
      ...
      call ESMF_TimeGet(ctime, yy=vl1(1), mm=vl1(2), dd=vl1(3),         &
                        h=vl1(4), m=vl1(5), s=vl1(6), rc=rc)
      if (CheckErr(rc,__LINE__,u_FILE_u)) return
...
!===============================================================================
!   
   logical function CheckErr(rc, line, file)
      !!--------------------------------------------------------------------
      !!             ***  ROUTINE CheckErr ***
      !!
      !! ** Purpose : Returns true if ESMF_LogFoundError() determines that
      !!              rc is an error code. Otherwise false
      !!--------------------------------------------------------------------
   ...
   end function CheckErr
!
!===============================================================================
!   
end module esm_shared
