...
!-----------------------------------------------------------------------
!
   character(len=4) :: INTPDES(0:5) = (/'NONE','BLIN','CON1','CON2','NS2D', 'ND2S'/)
   integer, parameter :: Inone  = 0 
   integer, parameter :: Ibilin = 1 
   integer, parameter :: Icons1 = 2
   integer, parameter :: Icons2 = 3
   integer, parameter :: Instod = 4
   integer, parameter :: Indtos = 5
   
!-----------------------------------------------------------------------
!     Extrapolation type        
!-----------------------------------------------------------------------
!
   character(len=4) :: EXTRDES(0:3) = (/'NONE','NEAR','INVD','CREE'/)
   integer, parameter :: Enone  = 0 
   integer, parameter :: Enear  = 1 
   integer, parameter :: Einvd  = 2
...
!-----------------------------------------------------------------------
!
   character(ESMF_MAXSTR) :: config_fname="namelist.esm"
